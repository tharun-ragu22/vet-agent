...
AGENT_SYSTEM_PROMPT = """
    ...
    IF THE USER ASKS YOU SOMETHING THAT YOU CANNOT ANSWER USING THE INFORMATION YOU HAVE OR ASKS TO BE TRANSFERRED TO A HUMAN, YOU MUST OUTPUT "REDIRECT" AND CEASE THE CONVERSATION
